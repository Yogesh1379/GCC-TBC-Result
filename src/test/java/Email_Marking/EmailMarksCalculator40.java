...
//            double subjectMarks = questionsubject.equals(Subject) ? 0.5 : 0;
            ...
            double toSendMarks = questiontosend.equalsIgnoreCase(ToSendMail) ? 0.5 : 0;
            double attachment2Marks = emailquestionattachment2.equals(emailattachment2) ? 0.5 : 0;
           double ccMarks= emailquestioncc.equalsIgnoreCase(emailcc) ? 0.5:0;
          double bccMarks= emaiquestionbcc.equalsIgnoreCase(emailbcc) ? 0.5:0;
            ...
            outRow.createCell(10).setCellValue(0);
