...
public class Compare_Result_and_Register_Finalonlymismatch {
    ...
    public static void main(String[] args) throws EncryptedDocumentException, IOException {
        ...
        String outputPath =
                "F:\\GCCTBC-APR 2026\\Register data\\Comparison_Output FINAL.xlsx";

        File oldFile =
                new File("F:\\GCCTBC-APR 2026\\Register data\\Workbook1.xlsx"); //result

        File newFile =
                new File("F:\\GCCTBC-APR 2026\\Register data\\Regi.xlsx"); // register
