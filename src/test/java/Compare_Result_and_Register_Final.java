...
public class Compare_Result_and_Register_Final {
    ...
    public static void main(String[] args) throws EncryptedDocumentException, IOException {
        ...
        String[] headers = {
                ...
                "Old Email Grace", "New Email Grace",
                ...
                "Old Inst Code", "New Inst Code"," Old Std name", "New Std name",
                "Status"
        };
        ...
        for (int i = 1; i <= newSheet.getLastRowNum(); i++) {
            ...
            String seat = df.formatCellValue(r.getCell(6)); // SeatNumber
            if (seat.isEmpty()) continue;
            ...
            if (old == null) {
                outRow.createCell(19).setCellValue("SEAT NOT FOUND IN RESULT");
                continue;
            }
...
//                    old[7].equals(newCenterAddr) &&
            ...
            outRow.createCell(c).setCellValue(match ? "MATCH" : "MISMATCH");
        }
