...
String outputPath = "C:\\Users\\User\\Desktop\\Register june\\final\\Compare\\Compare_Result_Marathi40.xlsx";
        File file1 = new File("C:\\Users\\User\\Desktop\\Register june\\final\\Marathi40 Register data.xlsx");// old--register
        File file2 = new File("C:\\Users\\User\\Desktop\\Register june\\final\\Marathi40 Result data.xlsx");// new--result
        ...
        for (int i = 1; i <= sheet1.getLastRowNum(); i++) {
            ...
            oldData.put(seat, new String[]{
                //df.formatCellValue(r.getCell(21)), // grace Marks (IGNORED in comparison)
                df.formatCellValue(r.getCell(22)),  // percent
                df.formatCellValue(r.getCell(23)),  // result
                df.formatCellValue(r.getCell(6)),   // center code
                df.formatCellValue(r.getCell(7)),   // center address
                df.formatCellValue(r.getCell(9)),   // inst code
                df.formatCellValue(r.getCell(13)),  // obj grace
                df.formatCellValue(r.getCell(18)),  // speed grace
                df.formatCellValue(r.getCell(20)),  // email stmt ltr garce
                df.formatCellValue(r.getCell(24))   // grade
            });
        }
        ...
        for (int i = 1; i <= sheet2.getLastRowNum(); i++) {
            ...
            // Read new values
            String newGraceMarks   = df.formatCellValue(r.getCell(21)); // will display but not compare
            String newPercent      = df.formatCellValue(r.getCell(22));
            String newResult       = df.formatCellValue(r.getCell(23));
            String newCenterCode   = df.formatCellValue(r.getCell(6));
            String newCenterAddr   = df.formatCellValue(r.getCell(7));
            String newInstCode     = df.formatCellValue(r.getCell(9));
            String newObjGrace     = df.formatCellValue(r.getCell(13));
            String newSpeedGrace   = df.formatCellValue(r.getCell(18));
            String newEmailGrace   = df.formatCellValue(r.getCell(20));
            String newGrade        = df.formatCellValue(r.getCell(24));
