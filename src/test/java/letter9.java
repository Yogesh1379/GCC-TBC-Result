...
public class letter9 {
    ...
    private static List<String> splitRunsIntoLines(XWPFParagraph p) {
        ...
        for (String line : lines) {
            ...
            else out.add(line); // IMPORTANT: do not trim here — keep exact internal/leading/trailing whitespace
        }
        return out;
    }
    ...
    private static String ensureStudentSpacingFromModel(String model, String student) {
        ...
        // --- existing punctuation spacing logic (applies to the student string with protected parts replaced) ---
        char[] puncts = {'.', ',', ';', ':', '!', '?', '-'};
        ...
        // student = student.replaceAll(" {2,}", " ").trim(); // removed
